                        ...
                        <div align="center" class="input-group"> 
                         <form id="upload_form" enctype="multipart/form-data" method="post"> 
                           ...
                           <div> <input  type="text" class="form-control" name="formdocutit" id="formdocutit"  placeholder="" ></div><br>
                                ...
                                <div><label for="TituloLabel">Criterios de Busqueda (Usa una coma (',') entre cada criterio)</label></div>
                                <div><input  class="block-tab" name="formdocutag" id="formdocutag"  placeholder="" ></div>    
    ...
    window.onload = function () {     
      ...
      recargarTabla();
          ...
          $('.block-tab').on('keyup', function(e) { 
              if (e.keyCode == 9 || e.keyCode == 1) e.preventDefault(); 
            });
